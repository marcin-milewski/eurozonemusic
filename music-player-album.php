...
<div class="gdlr-content">
					...
					<div class="gdlr-item gdlr-single-album gdlr-item-start-content">
						<div class="gdlr-album-info-wrapper">
							...
							<div class="gdlr-album-info">
								<?php if(!empty($album_info['composer'])){ ?>
								<div class="gdlr-album-composer">
									<span class="gdlr-head"><?php _e('Composer :', 'gdlr-song'); ?></span>
									<?php echo $album_info['composer']; ?>
								</div>
								<?php } ?>
	...
	//	Added option: Download music file enabled only for logged users
								...
								if ( is_user_logged_in() ) {
									...
									echo get_the_title();
									echo ' - '; 
									echo '<span class="album-composer" style="text-transform:capitalize;">'; 
									echo $post_option['artist']; 
									echo '</span>';
